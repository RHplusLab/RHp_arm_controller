...
void MTCTaskNode::setupPlanningScene()
{
  ...
  else if (level_ == 3)
  {
    ...
    obstacle2.primitives[0].type = shape_msgs::msg::SolidPrimitive::CYLINDER;
    obstacle2.primitives[0].dimensions = {cylinder_height*2 + gap - 0.00001, 0.02};
