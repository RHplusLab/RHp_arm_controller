...
private:
  ...
  double x1_coord_; double y1_coord_;
  double x2_coord_; double y2_coord_;
  double x3_coord_; double y3_coord_;
  double place_coord;
  int gripper_angle;
};
...
void MTCTaskNode::setupPlanningScene()
{
  ...
  pose.position.z = 0.01 + 0.001; // 땅바닥에 붙음
